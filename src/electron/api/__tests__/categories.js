...
describe('Categories handler', () => {
  ...
  it('createCategory creates new category', () => {
    return app
      .handleIncomingAction(categoryRoutines.create.request())
      .then(results => {
  ...
  it('rename renames category', () => {
    ...
    return app
      .handleIncomingAction(
        categoryRoutines.rename.request({
          name: 'Nature',
          uuid: 'category-1'
        })
      )
  ...
  it('mute mutes category', () => {
    ...
    return app
      .handleIncomingAction(categoryRoutines.mute.request('category-1'))
      .then(results => {
        expect(app.state).toHaveProperty('entities.categories', [
          expect.objectContaining({
            uuid: 'category-1',
  ...
  it('mute unmutes category', () => {
    ...
    return app
      .handleIncomingAction(categoryRoutines.unmute.request('category-1'))
      .then(results => {
        expect(app.state).toHaveProperty('entities.categories', [
          expect.objectContaining({
            uuid: 'category-1',
  ...
  it('loopOn turns loop on category', () => {
    ...
    return app
      .handleIncomingAction(categoryRoutines.loopOn.request('category-1'))
      .then(results => {
        expect(app.state).toHaveProperty('entities.categories', [
          expect.objectContaining({
            uuid: 'category-1',
  ...
  it('loopOff turns loop off category', () => {
    ...
    return app
      .handleIncomingAction(categoryRoutines.loopOff.request('category-1'))
      .then(results => {
        expect(app.state).toHaveProperty('entities.categories', [
          expect.objectContaining({
            uuid: 'category-1',
  ...
  it('exclusiveOn turns exclusive on category', () => {
    ...
    return app
      .handleIncomingAction(categoryRoutines.exclusiveOn.request('category-1'))
      .then(results => {
        expect(app.state).toHaveProperty('entities.categories', [
          expect.objectContaining({
            uuid: 'category-1',
  ...
  it('exclusiveOff turns exclusive off category', () => {
    ...
    return app
      .handleIncomingAction(categoryRoutines.exclusiveOff.request('category-1'))
      .then(results => {
        expect(app.state).toHaveProperty('entities.categories', [
          expect.objectContaining({
            uuid: 'category-1',
  ...
  it('soundAdd adds sound cachePath to the category', () => {
    ...
    return app
      .handleIncomingAction(
        categoryRoutines.soundAdd.request({
          sound: 'sound-1',
          uuid: 'category-1'
        })
      )
  ...
  it('soundRemove removes sound cachePath from the category', () => {
    ...
    return app
      .handleIncomingAction(
        categoryRoutines.soundRemove.request({
          sound: 'sound-2',
          uuid: 'category-1'
        })
      )
